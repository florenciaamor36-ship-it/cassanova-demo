...
export default function App() {
  ...
  return (
    <div className="relative h-[100dvh] max-h-[100dvh] w-full flex flex-col justify-between bg-black text-amber-100 overflow-hidden select-none">
      ...
      <main className="relative flex-1 min-h-0 w-full flex items-center justify-center px-1 sm:px-2 py-0.5 z-10 overflow-hidden">
        {/* Cleopatra decorative artwork: desktop only, absolutely positioned so the reels stay perfectly centered. */}
        <div className="hidden lg:flex absolute left-1 xl:left-4 2xl:left-10 top-1/2 -translate-y-1/2 w-28 xl:w-40 2xl:w-48 h-[78%] max-h-[520px] items-center justify-center pointer-events-none">
          <img
            src={cleopatraDesktopLeftImg}
            alt="Cleopatra de pie"
            className="w-full h-full object-contain drop-shadow-[0_8px_18px_rgba(0,0,0,0.85)]"
            referrerPolicy="no-referrer"
          />
        </div>

        {/* Center Column: Jackpots + Reel Cabinet + Dynamic Ticker */}
        <div className="relative z-10 w-full max-w-[820px] h-full flex flex-col items-center justify-between py-0.5 mx-auto">
